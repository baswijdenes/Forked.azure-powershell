...
```
Update-AzContainerRegistryConnectedRegistry -Name <String> -RegistryName <String> -ResourceGroupName <String>
 -ConnectedRegistryUpdateParameter <IConnectedRegistryUpdateParameters> [-SubscriptionId <String>]
...
Update-AzContainerRegistryConnectedRegistry -InputObject <IContainerRegistryIdentity>
 -ConnectedRegistryUpdateParameter <IConnectedRegistryUpdateParameters> [-DefaultProfile <PSObject>] [-AsJob]
 [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ContainerRegistry.Models.Api20220201Preview.IConnectedRegistryUpdateParameters
